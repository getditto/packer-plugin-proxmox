...
import (
	...
	proxmoxclone "github.com/getditto/packer-plugin-proxmox/builder/proxmox/clone"
	proxmoxiso "github.com/getditto/packer-plugin-proxmox/builder/proxmox/iso"
	"github.com/getditto/packer-plugin-proxmox/version"
)
